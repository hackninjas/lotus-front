...
const [isLoading, setIsLoading] = useState(false)
  ...
  const onDrop = useCallback(async (acceptedFiles) => {
    ...
    return (
      ...
      <Text fontSize="xs">I Don't have my Government issued Id card now.</Text>
      <Link fontSize="xs" color="lotusBlue.400" fontWeight="bold">Continue with other ID card types</Link>
      </VStack>
      </Flex>
  </UserDashboardLayout>
  )
